...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = new _vue2.default({
	  el: '#app',
	  components: { Snake: _Snake2.default }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] src/components/Snake.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/williambishop/WebstormProjects/Snake/src/components/Snake.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Snake.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Snake.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, "a{cursor:pointer;color:#006aff}table{border-collapse:collapse}.grid-cell{margin:0;padding:0;height:10px;width:10px;background-color:#f4f4f4;border:1px solid white}.food{background-color:#56b0bb}.snake{background-color:#3e3e3e}", ""]);
	...
	exports.default = {
	  ...
	  methods: {
	    start: function start() {
	      var size = 50,
	          ms = 65;
	      this.grid = new _Grid2.default(size, function (x, y) {
	        return { x: x, y: y, snake: 0, food: false };
	      });
	      this.dead = false;
	      userActions = [];
	      length = 5;
	      ...
	      snakePos = _Grid2.default.random(this.grid);
	    ...
	    moveSnake: function moveSnake() {
	      var _snakePos = snakePos;
	      var x = _snakePos.x;
	      var y = _snakePos.y;

	      var _direction = (0, _slicedToArray3.default)(this.direction, 2);
	      ...
	      snakeCells = snakeCells.filter(function (cell) {
	        return cell.snake > 0;
	      });
	    ...
	    setFood: function setFood() {
	      _Grid2.default.random(this.grid).food = true;
	    },
